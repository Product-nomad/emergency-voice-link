...
const howToStructuredData = {
  ...
  "@type": "HowTo",
  name: "How to Teach Kids to Call 911/999",
  description:
    "Step-by-step guide for parents and teachers on teaching children when and how to call 911/999. Learn safe practice methods and address memorisation tips.",
  ...
  step: [
    {
      ...
      text: "Tell your child that 911/999 is a special phone number that connects them to helpers like police, firefighters, and paramedics who come when someone is in danger.",
      position: 1,
    },
    {
      "@type": "HowToStep",
      name: "Show Them How to Dial",
      text: "Practice finding and pressing 9-1-1 or 9-9-9 on your phone. Explain that on most phones, emergency calls work even without a password.",
      position: 2,
    },
    {
      "@type": "HowToStep",
...
const Guide = () => {
  return (
    <MainLayout>
      <Helmet>
        <title>How to Teach Kids to Call 911/999 | Parents & Teachers Guide</title>
        <meta
          name="description"
          content="Step-by-step guide for parents and teachers on teaching children when and how to call 911. Learn safe practice methods and address memorization tips."
        />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <header className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">How to Teach Kids to Call 911/999</h1>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  In an emergency, a child who knows how to call 911/999 can save a life—including their own. Studies
                  show that children as young as 4 can learn to dial 911/999, but they need practice in a safe,
                  controlled environment to build confidence and muscle memory.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">When to Call 911/999</h2>
        ...
        <section className="mb-12">
          <div className="bg-accent/50 rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-6">
              One of the most critical pieces of information in an emergency is your home address. Here are proven
              methods to help children memorize it:
            </p>
        ...
        {/* Step-by-Step Guide */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Step-by-Step Teaching Guide</h2>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-2xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">Why Use This Simulator?</h2>
            <div className="max-w-2xl mx-auto space-y-4 text-muted-foreground">
              <p>
                <strong className="text-foreground">Safe Practice:</strong> Children can practice as many times as
                needed without accidentally calling real emergency services.
              </p>
              <p>
                <strong className="text-foreground">Realistic Experience:</strong> Our AI-powered dispatcher responds
                just like a real 911 operator, asking the same questions in a calm, reassuring voice.
              </p>
              <p>
                <strong className="text-foreground">Build Confidence:</strong> Familiarity reduces fear. When children
                know what to expect, they're more likely to act effectively in a real emergency.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-destructive/10 border border-destructive/30 rounded-2xl p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                This website is for educational purposes only. It does not connect to real emergency services. If you
                have an actual emergency, please dial 911 on your phone immediately.
              </p>
            </div>
          </div>
        </section>
